package com.learningsecurity.demo.config;
...
import com.learningsecurity.demo.filter.JwtFilter;
import com.learningsecurity.demo.service.UserServiceDetailImpl;
...
public class SpringSecurity{
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        ...
        http
            .cors(cors -> cors.configurationSource(corsConfigurationSource())) // Enable CORS with a specific configuration
